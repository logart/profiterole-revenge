...
<script type="text/javascript">
    ...
    var dayNames = [["Пн","Mo","Понедельник"], ["Вт","Tu","Вторник"], ["Ср","We","Среда"], ["Чт","Th","Четверг"],
    ["Пт","Fr","Пятница"], ["Сб","Sa","Суббота"], ["Вс","Su","Воскресенье"]] ;
    var    mealNames = [["Завтрак","breakfast"], ["Обед", "dinner"], ["Ужин", "supper"]];
