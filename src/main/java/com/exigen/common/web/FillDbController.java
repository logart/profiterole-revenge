...
public class FillDbController {
     ...
     * method inicialize variables for recipes and add it in smallImgList
     *
     * @throws javax.xml.crypto.Data (where ArrayList is empty), ResourceNotFoundException(where
     *                              link is empty)
     */
    ...
    public void addRecipes() {
        ...
        for (; i < (2 + 2); i++) {
            recipeList.add(new Recipe(titleList.get(i), descriptionList.get(i), cuisineList.get(1), categoriesList.get(0), bigImgList.get(i), smallImgList.get(i), timeList.get(i),123));
        }

        for (; i < (2 * 2 * 2); i++) {
            recipeList.add(new Recipe(titleList.get(i), descriptionList.get(i), cuisineList.get(1), categoriesList.get(1), bigImgList.get(i), smallImgList.get(i), timeList.get(i),123));
        }

        for (; i < (2 * 2 * 2 + 2 * 2); i++) {
            recipeList.add(new Recipe(titleList.get(i), descriptionList.get(i), cuisineList.get(1), categoriesList.get(2), bigImgList.get(i), smallImgList.get(i), timeList.get(i),123));
        }

        for (; i < (2 * 2 * 2 * 2); i++) {
            recipeList.add(new Recipe(titleList.get(i), descriptionList.get(i), cuisineList.get(1), categoriesList.get(2 + 1), bigImgList.get(i), smallImgList.get(i), timeList.get(i),123));
        }
        for (; i < (2 * 2 * 2 * 2 + 2 * 2); i++) {
            recipeList.add(new Recipe(titleList.get(i), descriptionList.get(i), cuisineList.get(1), categoriesList.get(2 + 2), bigImgList.get(i), smallImgList.get(i), timeList.get(i),123));
        }
    }
